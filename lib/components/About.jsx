  ...
  return (
    <div className="About">
      ...
      <section className="full card">
          ...
          <p>It's the satisfaction from finding the missing semicolon, or the penny that ties out the financial statements.  It{"'"}s the complicated process required to setup a code base, or a chart of accounts.  It all stems from a solid comprehension of the big picture, but a willingness to dig deep and <span>apply a technical skill to solve a problem.</span></p>

          <div className='story-header'>
            <img className='story' src="./lib/styles/images/223-man-woman.svg"></img>
            <h1 className="font">The people.</h1>
          </div>
          <p>Beyond the code, it's about creating remarkable and smooth digital experiences for <span>intentional user groups</span>.  It{"'"}s not unlike making financial maintenance easier for people by providing clear, concise, financially accurate data.</p>
          ...
          <p>
            One of the greatest joys is to see that magic glow in a child's eye.  The best twinkles are of course <span>my two kids radiant eyes staring back at me</span> and pushing me to be a better person, and a role model.  The nonprofit I cofounded, MindSpark, which has been running tinkering programs in schools and libraries for over five years, also strives to ignite an intellectual spark in kids ages 5-15.
          </p>
