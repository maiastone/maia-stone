const projects = [
  ...
  },
  {
    ...
    description: 'A weather app that allows the user to enter a city name or zipcode anywhere in the world, to see different forecast information and pin favorite cities to the home page.  We retrieved and displayed forecast data from the OpenWeatherMap API and used the Geolocation API to determine the weather in the current city. Note: CORS is not enabled, so in the live app, you must allow your browser to load "unsafe scripts".',
