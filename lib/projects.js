const projects = [
  ...
  },
  {
    ...
    description: 'A weather app that allows the user to enter a city name or zipcode anywhere in the world, to see different forecast information and pin favorite cities to the home page.  We retrieved and displayed forecast data from the OpenWeatherMap API and used the Geolocation API to determine the weather in the current city. Note: it is necessary to allow your browser to load "unsafe scripts" in order to render fresh weather information and current weather data. Setting up and enabling CORS for this app was beyond the time scope for this particular project.',
